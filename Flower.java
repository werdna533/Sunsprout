...
public class Flower {
	...
	private Image[] commonSprites = {	new ImageIcon("commonFlower0.png").getImage(), 
										new ImageIcon("commonFlower1.png").getImage(), 
										new ImageIcon("commonFlower2.png").getImage(),
										new ImageIcon("commonFlower3.png").getImage(),
										new ImageIcon("commonFlower4.png").getImage()};
	
	private Image[] rareSprites = {	new ImageIcon("rareFlower0.png").getImage(), 
									new ImageIcon("rareFlower1.png").getImage(), 
									new ImageIcon("rareFlower2.png").getImage(),
									new ImageIcon("rareFlower3.png").getImage(),
									new ImageIcon("rareFlower4.png").getImage()};
	
	private Image[] epicSprites = {	new ImageIcon("epicFlower0.png").getImage(), 
									new ImageIcon("epicFlower1.png").getImage(), 
									new ImageIcon("epicFlower2.png").getImage(),
									new ImageIcon("epicFlower3.png").getImage(),
									new ImageIcon("epicFlower4.png").getImage()};
