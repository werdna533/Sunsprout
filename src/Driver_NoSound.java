...
public class Driver_NoSound extends JPanel implements Runnable, MouseListener, MouseMotionListener, KeyListener {
	...
	private final Image pauseButton = new ImageIcon("pause0.png").getImage();
	private final Image pauseButtonHover = new ImageIcon("pause1.png").getImage();
	...
	private final Image commonFlowerImage = new ImageIcon("commonFlower4.png").getImage();
	private final Image rareFlowerImage = new ImageIcon("rareFlower4.png").getImage();
	private final Image epicFlowerImage = new ImageIcon("epicFlower4.png").getImage();
	...
	private final Image fireImage = new ImageIcon("fire.png").getImage();
	private final Image cloudImage = new ImageIcon("cloud0.png").getImage();
	private final Image cloudImage2 = new ImageIcon("cloud0.png").getImage();
	private final Image cloudImage3 = new ImageIcon("cloud0.png").getImage();
	...
	public Driver_NoSound() {
		...
		try {
			gameFont = Font.createFont(Font.TRUETYPE_FONT, new File("PressStart2P.ttf"));
	...
	public void loadProfiles() {
		// Load in the highscores from the highscores files and store them in sets
				try {
					BufferedReader reader = new BufferedReader(new FileReader("easyHighscores.txt"));
			        String line;
			        ...
			        BufferedReader reader2 = new BufferedReader(new FileReader("mediumHighscores.txt"));
			        ...
			        BufferedReader reader3 = new BufferedReader(new FileReader("hardHighscores.txt"));
	...
	public void saveProfiles() {
		try {
	        BufferedWriter writer = new BufferedWriter(new FileWriter("easyHighscores.txt"));
	        ...
	        BufferedWriter writer2 = new BufferedWriter(new FileWriter("mediumHighscores.txt"));
	        ...
	        BufferedWriter writer3 = new BufferedWriter(new FileWriter("hardHighscores.txt"));
	...
	public static void main(String[] args) throws IOException {
		...
		Driver_NoSound driver = new Driver_NoSound();
		frame.add(driver);
