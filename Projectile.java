...
public class Projectile {
    ...
    private final Image sunray = new ImageIcon("Projectile0.png").getImage();
    private final Image smallDrop = new ImageIcon("Projectile1.png").getImage();
    private final Image lightning = new ImageIcon("Projectile2.png").getImage();
